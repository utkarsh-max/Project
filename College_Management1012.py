...
def registeredstdata():
    ...
    if admissiontypeentryva=="" or obtainmarksentryva=="" or nameentryva=="" or fnameentryva=="" or mnameentryva=="" or dobentryva=="" or qualificationentryva=="" or mobilenumberva=="" or addressentryva=="":
        ...
        dbconfig()
        que="insert into student_detail(Addmision_Type,EntranceExam_Name,Total_Marks,Obtain_Marks," \
            "Name,FatherName,MotherName,DateOfBirth,Qualification,Mobile_Number,Email_ID,Address)" \
            "values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s);"
        val=(admissiontypeentryva,entrancenameva,totalmarksentryva,obtainmarksentryva,nameentryva,
             fnameentryva,mnameentryva,dobentryva,qualificationentryva,mobilenumberva,emailidva,
             addressentryva)
...
def conditional(event):
    ...
    if a=="Entrance":
        ...
        entrancename=Entry(root,state="readonly",textvar=entrancenamev)
